...
import { RectToRectUnfold } from "@/lib/geometry/rectToRect";

interface RectToRectCanvasProps {
  unfold: RectToRectUnfold;
  baseLength: number;
  baseWidth: number;
  topLength: number;
  topWidth: number;
...
export default function RectToRectCanvas({ unfold, baseLength, baseWidth, topLength, topWidth, height }: RectToRectCanvasProps) {
  ...
  const draw = useCallback(() => {
    ...
    // Linhas de dobra (quinas do retângulo)
