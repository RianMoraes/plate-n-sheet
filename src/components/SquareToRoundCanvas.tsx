...
import { SquareToRoundUnfold } from "@/lib/geometry/squareToRound";

interface SquareToRoundCanvasProps {
  unfold: SquareToRoundUnfold;
  squareSide: number;
...
export default function SquareToRoundCanvas({ unfold, squareSide, diameterSmall, height }: SquareToRoundCanvasProps) {
