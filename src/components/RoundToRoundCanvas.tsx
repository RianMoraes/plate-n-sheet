...
import { RoundToRoundUnfold } from "@/lib/geometry/roundToRound";

interface RoundToRoundCanvasProps {
  unfold: RoundToRoundUnfold;
  diameterBig: number;
...
export default function RoundToRoundCanvas({ unfold, diameterBig, diameterSmall, height, offsetX }: RoundToRoundCanvasProps) {
